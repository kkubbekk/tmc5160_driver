...
int main(void)
{
  ...
  /* USER CODE BEGIN 2 */
    ...
    TMC5160_t motor;
    motor.spi_instance = SPI1;
    motor.cs_port = GPIOA;
    motor.cs_pin = TMC_CS_Pin;
    motor.state = TMC_STATE_UNINITIALIZED;
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(PWR_CONVERTER_EN_GPIO_Port, PWR_CONVERTER_EN_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(SD_MODE_REAL_GPIO_Port, SD_MODE_REAL_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(SPI_EN_GPIO_Port, SPI_EN_Pin, GPIO_PIN_SET);

  /*Configure GPIO pins : STEP_PIN_Pin TMC_CS_Pin MOTOR_EN_Pin */
  GPIO_InitStruct.Pin = STEP_PIN_Pin|TMC_CS_Pin|MOTOR_EN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pins : PWR_CONVERTER_EN_Pin SPI_EN_Pin */
  GPIO_InitStruct.Pin = PWR_CONVERTER_EN_Pin|SPI_EN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pin : SD_MODE_REAL_Pin */
  GPIO_InitStruct.Pin = SD_MODE_REAL_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(SD_MODE_REAL_GPIO_Port, &GPIO_InitStruct);
